...
public class NumbersOnlyStrategy implements AsciiStrategy {
     ...
     *
     * @return A List of Characters, each representing a number in the ASCII
     * table.
     */
    @Override
    public List<Character> generateAsciiValues() {
        return IntStream.rangeClosed(AsciiRanges.ASCII_NUMBERS.getStart(),
                        AsciiRanges.ASCII_NUMBERS.getEnd()
                )
                .mapToObj(c -> (char) c)
